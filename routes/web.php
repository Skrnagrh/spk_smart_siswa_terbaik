...
Route::middleware('auth')->group(function () {
    ...
    // Perhitungan Smart
    Route::get('/dashboard/smart', [PerhitunganController::class, 'index'])->name('smart.index');
    Route::get('/dashboard/smart/hasil', [PerhitunganController::class, 'hasil'])->name('smart.hasil');
