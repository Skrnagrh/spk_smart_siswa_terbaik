        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/password" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="old-password-input">Kata Sandi Lama<span class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        <label for="new-password-input">Kata Sandi Baru<span class="text-danger">*</span></label>
                        <div class="input-group">
                    ...
                    <div class="mb-3">
                        <label for="confirm-password-input">Konfirmasi Kata Sandi Baru<span
